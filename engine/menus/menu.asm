...
.loop
	call Move2DMenuCursor
	farcall HDMATransferTilemapToWRAMBank3 ; BUG: This function is in another bank.
	call .loop2
	jr nc, .done
	call _2DMenuInterpretJoypad
	jr c, .done
...
.loop2
	...
	ld c, 1
	ld b, 3
	farcall AdvanceMobileInactivityTimerAndCheckExpired ; BUG: This function is in another bank.
	ret c
