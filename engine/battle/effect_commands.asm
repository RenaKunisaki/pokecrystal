...
.got_move_chance
    ...
    ; bugfix: 100% chance is now actually 100%, not 255/256
	ld a, [hl]
	sub 100 percent
...
.finish
    ; we already broke link compatibility, so who cares
	;ld a, [wLinkMode]
	;cp LINK_COLOSSEUM
	;jr z, .done
...
.mimic_screen
	...
	pop af
	ld e, a
    ; bugfix: confusion damage no longer affected by boost items, explosion, etc
	ld a, TRUE
