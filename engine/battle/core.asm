...
HasAnyoneFainted:
    ; added to fix bug with Perish Song/Spikes
...
.go
    ...
    ; bugfix: normal 2-5 turns, not 255/undefined
	ldh a, [hBattleTurn]
	and a
...
IsPluralTrainer: ; return z for plural trainers
	ld a, [wOtherTrainerClass]
	cp TWINS
	ret
...
.count_loop
	...
	ld a, [wPartyCount]
	cp c
    ; assumes PARTY_LENGTH < MAX_LEVEL
	jr c, .no_mon
	ld a, c
	dec a
